									...
									<?php
										...
										<tr align="center">
											...
											<td align="center">
												...
												<a href="#myModal" data-toggle="modal" data-load-code="<?php echo $result['kode_booking']; ?>" data-remote-target="#myModal .modal-body" class="btn btn-xs btn-info" style="margin-bottom: 5px">Detail</a>&nbsp;&nbsp;												
												<?php
												}else{
													?>
													<a href="#myModal" data-toggle="modal" data-load-code="<?php echo $result['kode_booking']; ?>" data-remote-target="#myModal .modal-body" class="btn btn-xs btn-info" style="margin-bottom: 5px">Detail</a>&nbsp;&nbsp;
													<a href="selesai.php?id=<?php echo $result['kode_booking'];?>" class="btn btn-xs btn-primary" style="margin-bottom: 5px" onclick="return confirm('Apakah anda yakin akan menyelesaikan transkasi <?php echo $result['kode_booking'];?>?');">Selesai</a>
													<a href="hilang.php?id=<?php echo $result['kode_booking'];?>" class="btn btn-xs btn-danger" style="margin-bottom: 5px" onclick="return confirm('Apakah anda yakin akan mengubah status <?php echo $result['kode_booking'];?> menjadi HILANG/RUSAK?');">Hilang/Rusak</a>
												<?php
												}?>
											</td>
										</tr>
