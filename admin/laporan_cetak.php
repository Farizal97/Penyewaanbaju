...
$stt	 = "Sudah Dibayar";
$stt1	 = "Selesai";
$sqlsewa = "SELECT * FROM booking WHERE status='$stt' OR status='$stt1' AND tgl_booking BETWEEN '$awal' AND '$akhir'";
/*$stt	 = "Sudah Dibayar";
			...
			<table class="table table-borderless">
				<tbody>
					<tr>
						...
						<td class="text-center"><h3>SewaBaju.com</h3></td>
			...
			<table id="zctb" class="display table table-striped table-bordered table-hover" cellspacing="0" width="100%">
				...
				<?php
					...
					while($result = mysqli_fetch_array($querysewa)) {
						...
						$sqlbaju = "SELECT * FROM baju WHERE id_baju='$idbaju'";
						$querybaju = mysqli_query($koneksidb,$sqlbaju);
						$resultbaju = mysqli_fetch_array($querybaju);
						$total=$result['durasi']*$resultbaju['harga'];
						$pemasukan += $total; 
						$no++;
				?>	
					<tr align="center">
