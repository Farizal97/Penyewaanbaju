...
$sql = "SELECT id_baju FROM baju WHERE kategori='Anak Laki-Laki'";
...
<?php 
$sql1 = "SELECT baju.*,jenis.* FROM baju,jenis WHERE baju.id_jenis=jenis.id_jenis AND baju.kategori='Anak Laki-Laki'";
          ...
          <div class="recent_addedcars">
			...
			<?php
				$sql2 = "SELECT baju.*,jenis.* FROM baju,jenis 
						WHERE baju.id_jenis=jenis.id_jenis AND kategori='Anak Laki-Laki' ORDER BY baju.id_baju DESC limit 4";
