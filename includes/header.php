    ...
    <div class="container">
      <div class="row">
        <div class="col-sm-3 col-md-3">
          <div class="logo"><a href="index.php"><img src="admin/img/icon.png" width="100px" height="40px" alt="image"/></a> </div>
        </div>
        <div class="col-sm-8 col-md-8">
          <div class="header_info">
            <div class="header_widgets">
              ...
              <a href="mailto:ask@menaratnt.com">ask@sewabaju.com</a> </div>
            <div class="header_widgets">
