...
<?php 
$kode=$_GET['kode'];
$sql1 	= "SELECT booking.*,baju.*, jenis.* FROM booking, baju, jenis WHERE booking.id_baju=baju.id_baju
		   AND baju.id_jenis=jenis.id_jenis AND booking.kode_booking='$kode'";
