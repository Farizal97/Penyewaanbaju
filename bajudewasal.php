  ...
  <div class="container">
    <div class="page-header_wrap">
      <div class="page-heading">
        <h1>Daftar Baju Laki-Laki Dewasa</h1>
      </div>
      <ul class="coustom-breadcrumb">
        <li><a href="#">Home</a></li>
        <li>Daftar Baju Laki-Laki Dewasa</li>
      </ul>
    </div>
  </div>
...
$sql = "SELECT id_baju FROM baju WHERE kategori='Dewasa Laki-Laki'";
...
<?php 
$sql1 = "SELECT baju.*,jenis.* FROM baju,jenis WHERE baju.id_jenis=jenis.id_jenis AND baju.kategori='Dewasa Laki-Laki'";
          ...
          <div class="recent_addedcars">
			...
			<?php
				$sql2 = "SELECT baju.*,jenis.* FROM baju,jenis 
						WHERE baju.id_jenis=jenis.id_jenis AND kategori='Dewasa Laki-Laki' ORDER BY baju.id_baju DESC limit 4";
