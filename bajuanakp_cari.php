      ...
      <div class="col-md-9 col-md-push-3">
        <div class="result-sorting-wrapper">
          <div class="sorting-count">
			...
			?>
			<p><span><?php echo htmlentities($cnt);?> Baju Ditemukan</span></p>
			</div>
		</div>

<?php 
$sql1 = "SELECT baju.*,jenis.* FROM baju,jenis WHERE baju.id_jenis=jenis.id_jenis AND jenis.id_jenis='$jenis' AND baju.kategori='Anak Perempuan'";
          ...
          <div class="recent_addedcars">
			...
			<?php
				$sql2 = "SELECT baju.*,jenis.* FROM baju,jenis 
						WHERE baju.id_jenis=jenis.id_jenis AND baju.kategori ='Anak Perempuan' ORDER BY baju.id_baju DESC limit 4";
